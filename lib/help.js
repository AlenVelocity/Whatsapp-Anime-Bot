...
*Usage: Send an image with #sticker as caption*

*CMD: #gsticker* 🏷️
*Description: Turns gifs/videos into animated stickers*
*Usage: Send an image with #gsticker as caption*

*CMD: #tsticker* ♥️
*Description: Removes the background of images and turns into stickers*
*Usage: Send an image with #tsticker as caption*
...
*Devs and Contributors* ❤️

Ban Takahiro (O) - _Base code and major commands - Bot Manager_

Dominick H - _Role/xp system and code moderation -  Bot Manager_

Takeshi Stark - _Random doujin command - Bot admin_

Milliana Blue -  _Assets and Command Ideas -  Bot admin_

Aman Sakuya -  _Assets and Command ideas - Bot admin_

Mystery The Ripper -  _Command Validation - Bot admin_

ShellTear - _Code Cleaning_ 

Matsuyama Hideki - _Bot admin_

Yaguchi Hastuharu -  Bot admin_

Suzuya XII -  _Bot Admin_

NekzySupportive -  _Bot Admin_

Special thanks to YogaSakti for helpingus with the code: https://github.com/YogaSakti/`
